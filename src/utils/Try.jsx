...
export async function downloadToFolder(
  ...
  let baseNotificationRI = initBaseNotificationRequestInput(
    filename,
    channelId
  );
  ...
  const dlNotificationRI = getNotifParams(
    baseNotificationRI,
    "downloading",
    customNotifContent
  );
  const errNotificationRI = getNotifParams(
    baseNotificationRI,
    "error",
    customNotifContent
  );
  const finNotificationRI = getNotifParams(
    baseNotificationRI,
    "finished",
    customNotifContent
  );
